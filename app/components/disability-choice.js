  ...
  return (
    <div>
      ...
      >
        <Box sx={modalStyle}>
          <h2 style={headingStyle}>
            Would you like to share your disabilities?
          </h2>
          <p style={paragraphStyle}>
            This helps us provide personalized accessibility features.
          </p>
          <Stack
            direction="row"
            spacing={2}
            ...
            sx={{ mt: 3 }}
          >
            <Button onClick={handleCloseModalOne} variant="contained">
              No
            </Button>
            <Button onClick={handleOpenModalTwo} variant="contained">
              Yes
            </Button>
          </Stack>
        </Box>
      ...
      >
        ...
        >
          <h2 className="text-black dark:text-white mb-5 text-2xl">Select your Disabilities</h2>
          <p className="text-black dark:text-white mb-6 text-md">Choose any that apply</p>
                      ...
                      return (
                        <Box key={item.value} sx={{ width: "50%" }}>
                          <ListItem>
                            <ListItemButton
                              role={undefined}
                              onClick={() => handleDisabilityToggle(item.value)}
                              dense
                            >
                              <ListItemIcon>
                                <Checkbox
                                  ...
                                  disableRipple
                                  sx={{ color: savedTheme === "dark" ? "#fefefe" : "black", }}
                                />
                              </ListItemIcon>
                              <ListItemText
                                id={item.value}
