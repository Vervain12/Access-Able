    ...
    if (files.length > 0 && reviewId) {
      ...
      if (imageResult.error) {
        if (imageResult.error === "CONTENT_POLICY_VIOLATION") {
          ...
          setErrorMessage(
            "There was an error when uploading the review images."
          );
        }
        setSubmitting(false);
        return;
      ...
      >
        <Box
          sx={(theme) => ({
            ...
            width: 400,
            bgcolor:
              savedTheme === "dark" ? "oklch(0.129 0.042 264.695)" : "white",
                ...
                <TextField
                  ...
                  sx={{
                    ...
                    "& .MuiOutlinedInput-notchedOutline": {
                      borderColor: savedTheme === "dark" ? "white" : "black",
                    },
                  }}
                />
                {/*Dropzone*/}
